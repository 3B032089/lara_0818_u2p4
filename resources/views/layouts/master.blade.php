...
<html lang="en">
    ...
    <body>
        ...
        @yield('content')
                    ...
                    <!-- Post preview-->
                    <div class="post-preview">
                        <a href="{{asset('post')}}"><h2 class="post-title">I believe every human has a finite number of heartbeats. I don't intend to waste any of mine.</h2></a>
                        <p class="post-meta">
                            Posted by
                            <a href="{{asset('#!')}}">Start Bootstrap</a>
                    ...
                    <hr class="my-4" />
                    <!-- Pager-->
                    <div class="d-flex justify-content-end mb-4"><a class="btn btn-primary text-uppercase" href="{{asset('#!')}}">Older Posts →</a></div>
                </div>
            </div>
        </div>
        <!-- Footer-->
